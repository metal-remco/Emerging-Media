		...
		if(!$_POST['subscribe'] && $type): ?>
            ...
            <form action="index.php?view=subscribe" method="post">
				...
				<?php if($type == 'parent'): ?>
                    ...
                    <input type="text" name="child_name" id="child_name" value="" tabindex="3" /><br />
                     
                    <label for="child_class">Klas van uw kind:</label>
                    <input type="text" name="child_class" id="child_class" value="" tabindex="4" /><br />
                ...
                <?php if($type == 'employee'): ?>
                    ...
                    <input type="text" name="employee_function" id="employee_function" value="" tabindex="3" /><br />
                     
                    <label for="employee_class">Uw klas:</label><!-- Todo: Alleen weergeven als dit een leerkracht is -->
                    <input type="text" name="employee_class" id="employee_class" value="" tabindex="4" /><br />
